...
void loop(){
    data[0] = analogRead(pin_x) - 441; // Смещаем ось на 441, чтобы начальное положение было примерно на 70
    data[1] = analogRead(pin_y) - 411; // Смещаем ось на 441, чтобы начальное положение было примерно на 70
